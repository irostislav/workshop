...
create unique index IDX_WORKSHOP_CLIENT_UK_EMAIL on WORKSHOP_CLIENT (EMAIL) where DELETE_TS is null ^
-- end WORKSHOP_CLIENT
...
create unique index IDX_WORKSHOP_SPARE_PART_UK_TITLE on WORKSHOP_SPARE_PART (TITLE) where DELETE_TS is null ^
